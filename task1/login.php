...
<?php
	...
	if (isset($_POST['user'])){
		...
		$sql = "SELECT * from users where email='$email' and password='$password' and isAdmin='0'";
...
<?php
	  ...
	  ?>
					...
					<label>Email</label>
					<input class="w3-input" type="email" name="user[email]" required="required"></p>
					<p>
					<label>Password</label>
					<input class="w3-input" type="password" name="user[password]" required="required"></p>
